...
(function ($) {
    ...
    var SwaggerBootstrapUi=function (options) {
        //swagger请求api地址
        this.url="swagger-resources.json";
        //文档id
        this.docId="content";
        //tabid
        this.tabId="tabUl";
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $.each(groupData,function (i, group) {
                    ...
                    //var extBasePath="";
					var extBasePath="http://192.168.123.52:8090/hp";
...
//                  data = 
            ...
            if(len==0){
                ...
                $.each(tag.childrens,function (i, children) {
                    ...
                    if(that.settings.showApiUrl){
                        //显示api地址
                        childrenLi=$('<li class="menuLi" ><div class="mhed"><div class="swu-hei"><span class="swu-menu swu-left"><span class="menu-url-'+children.methodType.
                        
                        ()+'">'+children.methodType.toUpperCase()+'</span></span><span class="swu-menu swu-left"><span class="menu-url">'+children.summary+'</span></span></div><div class="swu-menu-api-des"><span>'+children.showUrl+'</span></div></div></li>');
                    }else{
                        //不显示api地址
    ...
    SwaggerBootstrapUi.prototype.welcome=function () {
    	...
    	//新增数据解析
	SwaggerBootstrapUi.prototype.changeData=function (data) {
		var myNewData = {};
		myNewData.tags = [];
		data = data.data.paths;
		for (var i=0;i<data.length;i++) {
			var param = {};
			param.name = data[i].serviceName+"("+data[i].desc+")";
			param.description = data[i].desc;
			myNewData.tags.push(param);
		}
